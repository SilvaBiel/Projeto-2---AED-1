...
class Loja{
  ...
  List<int> Quantidade = new List<int>{ 10,13,66,69,15,4,7,3,26,29,19,49,157,2,24,88,76,38,84,7,2,4,24,96,9,60,18,14,2,82,10,94,96,46,3,12,13,8,38,35,8,21,12,25,28,5,38,56,199,44,22,21,70,20,7,37 };
